...
.forEach(el =>{
    ...
    statusElem.innerText = `Status: ${el.online ? 'anline' : 'offline'}`;
    ...
    //  avatar.setAttribute('alt' `${el.firstname} ${el.lastname}`);
    avatarElem.src = el.avatar;
    avatarElem.alt = `${el.firstname} ${el.lastname}`;// - это два способа коротких обращение к атрибутам
...
//обязательные атрибуты у тега img это-src,alt
//src ссылка на картинку
//alt - альтернативный текст и отвичает за поиск картинки
